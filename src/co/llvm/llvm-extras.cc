...
template <typename F>
static bool _link(F linkf, const char* arg0, int argc, const char** argv, char** errmsg) {
  if (_lld_is_corrupt) {
...
bool lld_link_macho(int argc, const char** argv, char** errmsg) {
  ...
  return _link(lld::mach_o::link, "ld64.lld", argc, argv, errmsg);
}

bool lld_link_coff(int argc, const char** argv, char** errmsg) {
  return _link(lld::coff::link, "lld-link", argc, argv, errmsg);
}

bool lld_link_elf(int argc, const char** argv, char** errmsg) {
  return _link(lld::elf::link, "ld.lld", argc, argv, errmsg);
}

bool lld_link_wasm(int argc, const char** argv, char** errmsg) {
  return _link(lld::wasm::link, "wasm-ld", argc, argv, errmsg);
}
