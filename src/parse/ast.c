...
const char* NodeKindName(NodeKind k) {
  ...
  static const char* const kNodeNameTable[31] = {
    "Bad", "Pkg", "File", "Comment", "Lol", "BoolLit", "IntLit", "FloatLit",
    "StrLit", "Nil", "Id", "BinOp", "UnaryOp", "Array", "Fun", "Macro", "Call",
    "TypeCast", "Field", "Var", "Ref", "NamedVal", "Selector", "Index", "Slice",
    "If", "BasicType", "ArrayType", "TupleType", "StructType", "FunType"
  };
  return k < 31 ? kNodeNameTable[k] : "?";
}
