...
R_TEST(typeid) {
  ...
  { // (int, int, bool) => "(iib)"
    ...
    NodeArrayAppend(mem, &tupleType->t.list.a, Type_int);
    NodeArrayAppend(mem, &tupleType->t.list.a, Type_int);
    NodeArrayAppend(mem, &tupleType->t.list.a, Type_bool);
  ...
  { // ((int, int), (bool, int), int) => "((ii)(bi)i)"
    ...
    NodeArrayAppend(mem, &t2->t.list.a, Type_bool);
    NodeArrayAppend(mem, &t2->t.list.a, Type_int);

    Node* t1 = mknode(NTupleType);
    NodeArrayAppend(mem, &t1->t.list.a, Type_int);
    NodeArrayAppend(mem, &t1->t.list.a, Type_int);

    Node* t0 = mknode(NTupleType);
    NodeArrayAppend(mem, &t0->t.list.a, t1);
    NodeArrayAppend(mem, &t0->t.list.a, t2);
    NodeArrayAppend(mem, &t0->t.list.a, Type_int);
    ...
    NodeArrayAppend(mem, &t2b->t.list.a, Type_bool);
    NodeArrayAppend(mem, &t2b->t.list.a, Type_int);

    Node* t1b = mknode(NTupleType);
    NodeArrayAppend(mem, &t1b->t.list.a, Type_int);
    NodeArrayAppend(mem, &t1b->t.list.a, Type_int);

    Node* t0b = mknode(NTupleType);
    NodeArrayAppend(mem, &t0b->t.list.a, t1b);
    NodeArrayAppend(mem, &t0b->t.list.a, t2b);
    NodeArrayAppend(mem, &t0b->t.list.a, Type_int);
    ...
    NodeArrayAppend(mem, &t2c->t.list.a, Type_bool);
    NodeArrayAppend(mem, &t2c->t.list.a, Type_int);

    Node* t1c = mknode(NTupleType);
    NodeArrayAppend(mem, &t1c->t.list.a, Type_int);
    NodeArrayAppend(mem, &t1c->t.list.a, Type_int);

    Node* t0c = mknode(NTupleType);
    NodeArrayAppend(mem, &t0c->t.list.a, t1c);
    NodeArrayAppend(mem, &t0c->t.list.a, t2c);
    NodeArrayAppend(mem, &t0c->t.list.a, Type_bool);
  ...
  { // fun (int,bool) -> int
    ...
    NodeArrayAppend(mem, &params->t.list.a, Type_int);
    NodeArrayAppend(mem, &params->t.list.a, Type_bool);
  ...
  { // ( fun(int,bool)->int, fun(int)->bool, fun()->(int,bool) )
    ...
    NodeArrayAppend(mem, &result->t.list.a, Type_int);
    NodeArrayAppend(mem, &result->t.list.a, Type_bool);
    Node* f3 = mknode(NFunType);
    f3->t.fun.result = result;

    Node* t1 = mknode(NTupleType);
    NodeArrayAppend(mem, &t1->t.list.a, f1);
    NodeArrayAppend(mem, &t1->t.list.a, f2);
    NodeArrayAppend(mem, &t1->t.list.a, f3);
