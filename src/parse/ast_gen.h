...
// kNodeStructSizeTab[NodeKind] => sizeof(STRUCT)
extern const u8 kNodeStructSizeTab[46];
...
#define ASTVisit(v, flags, parent, n) _Generic((n), \
  BadNode*: (v)->ftable[NBad]((v),(flags),(parent),(Node*)(n)), \
  FieldNode*: (v)->ftable[NField]((v),(flags),(parent),(Node*)(n)), \
  PkgNode*: (v)->ftable[NPkg]((v),(flags),(parent),(Node*)(n)), \
  FileNode*: (v)->ftable[NFile]((v),(flags),(parent),(Node*)(n)), \
  CommentNode*: (v)->ftable[NComment]((v),(flags),(parent),(Node*)(n)), \
  NilNode*: (v)->ftable[NNil]((v),(flags),(parent),(Node*)(n)), \
  BoolLitNode*: (v)->ftable[NBoolLit]((v),(flags),(parent),(Node*)(n)), \
  IntLitNode*: (v)->ftable[NIntLit]((v),(flags),(parent),(Node*)(n)), \
  FloatLitNode*: (v)->ftable[NFloatLit]((v),(flags),(parent),(Node*)(n)), \
  StrLitNode*: (v)->ftable[NStrLit]((v),(flags),(parent),(Node*)(n)), \
  IdNode*: (v)->ftable[NId]((v),(flags),(parent),(Node*)(n)), \
  BinOpNode*: (v)->ftable[NBinOp]((v),(flags),(parent),(Node*)(n)), \
  PrefixOpNode*: (v)->ftable[NPrefixOp]((v),(flags),(parent),(Node*)(n)), \
  PostfixOpNode*: (v)->ftable[NPostfixOp]((v),(flags),(parent),(Node*)(n)), \
  ReturnNode*: (v)->ftable[NReturn]((v),(flags),(parent),(Node*)(n)), \
  AssignNode*: (v)->ftable[NAssign]((v),(flags),(parent),(Node*)(n)), \
  TupleNode*: (v)->ftable[NTuple]((v),(flags),(parent),(Node*)(n)), \
  ArrayNode*: (v)->ftable[NArray]((v),(flags),(parent),(Node*)(n)), \
  BlockNode*: (v)->ftable[NBlock]((v),(flags),(parent),(Node*)(n)), \
  FunNode*: (v)->ftable[NFun]((v),(flags),(parent),(Node*)(n)), \
  CallNode*: (v)->ftable[NCall]((v),(flags),(parent),(Node*)(n)), \
  TemplateNode*: (v)->ftable[NTemplate]((v),(flags),(parent),(Node*)(n)), \
  TemplateInstanceNode*: (v)->ftable[NTemplateInstance]((v),(flags),(parent),(Node*)(n)), \
  TypeCastNode*: (v)->ftable[NTypeCast]((v),(flags),(parent),(Node*)(n)), \
  ConstNode*: (v)->ftable[NConst]((v),(flags),(parent),(Node*)(n)), \
  VarNode*: (v)->ftable[NVar]((v),(flags),(parent),(Node*)(n)), \
  ParamNode*: (v)->ftable[NParam]((v),(flags),(parent),(Node*)(n)), \
  TemplateParamNode*: (v)->ftable[NTemplateParam]((v),(flags),(parent),(Node*)(n)), \
  RefNode*: (v)->ftable[NRef]((v),(flags),(parent),(Node*)(n)), \
  NamedArgNode*: (v)->ftable[NNamedArg]((v),(flags),(parent),(Node*)(n)), \
  SelectorNode*: (v)->ftable[NSelector]((v),(flags),(parent),(Node*)(n)), \
  IndexNode*: (v)->ftable[NIndex]((v),(flags),(parent),(Node*)(n)), \
  SliceNode*: (v)->ftable[NSlice]((v),(flags),(parent),(Node*)(n)), \
  IfNode*: (v)->ftable[NIf]((v),(flags),(parent),(Node*)(n)), \
  TypeExprNode*: (v)->ftable[NTypeExpr]((v),(flags),(parent),(Node*)(n)), \
  TypeTypeNode*: (v)->ftable[NTypeType]((v),(flags),(parent),(Node*)(n)), \
  IdTypeNode*: (v)->ftable[NIdType]((v),(flags),(parent),(Node*)(n)), \
  AliasTypeNode*: (v)->ftable[NAliasType]((v),(flags),(parent),(Node*)(n)), \
  RefTypeNode*: (v)->ftable[NRefType]((v),(flags),(parent),(Node*)(n)), \
  BasicTypeNode*: (v)->ftable[NBasicType]((v),(flags),(parent),(Node*)(n)), \
  ArrayTypeNode*: (v)->ftable[NArrayType]((v),(flags),(parent),(Node*)(n)), \
  TupleTypeNode*: (v)->ftable[NTupleType]((v),(flags),(parent),(Node*)(n)), \
  StructTypeNode*: (v)->ftable[NStructType]((v),(flags),(parent),(Node*)(n)), \
  FunTypeNode*: (v)->ftable[NFunType]((v),(flags),(parent),(Node*)(n)), \
  TemplateTypeNode*: (v)->ftable[NTemplateType]((v),(flags),(parent),(Node*)(n)), \
  TemplateParamTypeNode*: (v)->ftable[NTemplateParamType]((v),(flags),(parent),(Node*)(n)), \
  Node*: (v)->ftable[(n)->kind]((v),(flags),(parent),(Node*)(n)), \
  Stmt*: (v)->ftable[(n)->kind]((v),(flags),(parent),(Node*)(n)), \
  struct CUnitNode*: (v)->ftable[(n)->kind]((v),(flags),(parent),(Node*)(n)), \
  Expr*: (v)->ftable[(n)->kind]((v),(flags),(parent),(Node*)(n)), \
  struct LitExpr*: (v)->ftable[(n)->kind]((v),(flags),(parent),(Node*)(n)), \
  struct UnaryOpNode*: (v)->ftable[(n)->kind]((v),(flags),(parent),(Node*)(n)), \
  struct ListExprNode*: (v)->ftable[(n)->kind]((v),(flags),(parent),(Node*)(n)), \
  struct LocalNode*: (v)->ftable[(n)->kind]((v),(flags),(parent),(Node*)(n)), \
  Type*: (v)->ftable[(n)->kind]((v),(flags),(parent),(Node*)(n)))

struct ASTVisitorFuns {
  int(*nullable Bad)(ASTVisitor*, usize, const ASTParent*, BadNode*);
  int(*nullable Field)(ASTVisitor*, usize, const ASTParent*, FieldNode*);
  int(*nullable Pkg)(ASTVisitor*, usize, const ASTParent*, PkgNode*);
  int(*nullable File)(ASTVisitor*, usize, const ASTParent*, FileNode*);
  int(*nullable Comment)(ASTVisitor*, usize, const ASTParent*, CommentNode*);
  int(*nullable Nil)(ASTVisitor*, usize, const ASTParent*, NilNode*);
  int(*nullable BoolLit)(ASTVisitor*, usize, const ASTParent*, BoolLitNode*);
  int(*nullable IntLit)(ASTVisitor*, usize, const ASTParent*, IntLitNode*);
  int(*nullable FloatLit)(ASTVisitor*, usize, const ASTParent*, FloatLitNode*);
  int(*nullable StrLit)(ASTVisitor*, usize, const ASTParent*, StrLitNode*);
  int(*nullable Id)(ASTVisitor*, usize, const ASTParent*, IdNode*);
  int(*nullable BinOp)(ASTVisitor*, usize, const ASTParent*, BinOpNode*);
  int(*nullable PrefixOp)(ASTVisitor*, usize, const ASTParent*, PrefixOpNode*);
  int(*nullable PostfixOp)(ASTVisitor*, usize, const ASTParent*, PostfixOpNode*);
  int(*nullable Return)(ASTVisitor*, usize, const ASTParent*, ReturnNode*);
  int(*nullable Assign)(ASTVisitor*, usize, const ASTParent*, AssignNode*);
  int(*nullable Tuple)(ASTVisitor*, usize, const ASTParent*, TupleNode*);
  int(*nullable Array)(ASTVisitor*, usize, const ASTParent*, ArrayNode*);
  int(*nullable Block)(ASTVisitor*, usize, const ASTParent*, BlockNode*);
  int(*nullable Fun)(ASTVisitor*, usize, const ASTParent*, FunNode*);
  int(*nullable Call)(ASTVisitor*, usize, const ASTParent*, CallNode*);
  int(*nullable Template)(ASTVisitor*, usize, const ASTParent*, TemplateNode*);
  int(*nullable TemplateInstance)(ASTVisitor*, usize, const ASTParent*, TemplateInstanceNode*);
  int(*nullable TypeCast)(ASTVisitor*, usize, const ASTParent*, TypeCastNode*);
  int(*nullable Const)(ASTVisitor*, usize, const ASTParent*, ConstNode*);
  int(*nullable Var)(ASTVisitor*, usize, const ASTParent*, VarNode*);
  int(*nullable Param)(ASTVisitor*, usize, const ASTParent*, ParamNode*);
  int(*nullable TemplateParam)(ASTVisitor*, usize, const ASTParent*, TemplateParamNode*);
  int(*nullable Ref)(ASTVisitor*, usize, const ASTParent*, RefNode*);
  int(*nullable NamedArg)(ASTVisitor*, usize, const ASTParent*, NamedArgNode*);
  int(*nullable Selector)(ASTVisitor*, usize, const ASTParent*, SelectorNode*);
  int(*nullable Index)(ASTVisitor*, usize, const ASTParent*, IndexNode*);
  int(*nullable Slice)(ASTVisitor*, usize, const ASTParent*, SliceNode*);
  int(*nullable If)(ASTVisitor*, usize, const ASTParent*, IfNode*);
  int(*nullable TypeExpr)(ASTVisitor*, usize, const ASTParent*, TypeExprNode*);
  int(*nullable TypeType)(ASTVisitor*, usize, const ASTParent*, TypeTypeNode*);
  int(*nullable IdType)(ASTVisitor*, usize, const ASTParent*, IdTypeNode*);
  int(*nullable AliasType)(ASTVisitor*, usize, const ASTParent*, AliasTypeNode*);
  int(*nullable RefType)(ASTVisitor*, usize, const ASTParent*, RefTypeNode*);
  int(*nullable BasicType)(ASTVisitor*, usize, const ASTParent*, BasicTypeNode*);
  int(*nullable ArrayType)(ASTVisitor*, usize, const ASTParent*, ArrayTypeNode*);
  int(*nullable TupleType)(ASTVisitor*, usize, const ASTParent*, TupleTypeNode*);
  int(*nullable StructType)(ASTVisitor*, usize, const ASTParent*, StructTypeNode*);
  int(*nullable FunType)(ASTVisitor*, usize, const ASTParent*, FunTypeNode*);
  int(*nullable TemplateType)(ASTVisitor*, usize, const ASTParent*, TemplateTypeNode*);
  int(*nullable TemplateParamType)(ASTVisitor*, usize, const ASTParent*, TemplateParamTypeNode*);

  // class-level visitors called for nodes without specific visitors
  int(*nullable Stmt)(ASTVisitor*, usize, const ASTParent*, Stmt*);
  int(*nullable CUnit)(ASTVisitor*, usize, const ASTParent*, struct CUnitNode*);
  int(*nullable Expr)(ASTVisitor*, usize, const ASTParent*, Expr*);
  int(*nullable LitExpr)(ASTVisitor*, usize, const ASTParent*, struct LitExpr*);
  int(*nullable UnaryOp)(ASTVisitor*, usize, const ASTParent*, struct UnaryOpNode*);
  int(*nullable ListExpr)(ASTVisitor*, usize, const ASTParent*, struct ListExprNode*);
  int(*nullable Local)(ASTVisitor*, usize, const ASTParent*, struct LocalNode*);
  int(*nullable Type)(ASTVisitor*, usize, const ASTParent*, Type*);

  // catch-all fallback visitor
  int(*nullable Node)(ASTVisitor*, usize, const ASTParent*, Node*);
};
